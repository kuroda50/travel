...
class AppColor {
  ...
  static const Color subBackgroundColor = Color(0xF9F7F5); //2つ目のアプリの背景色
  ...
  static const Color mainButtonColor = Color(0x559900); //1つ目のボタンカラー
  static const Color subButtonColor = Color(0xE0E0E0); //2つ目のボタンカラー
