...
import 'models/account_filter_params.dart';
  ...
  routes: [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) {
        final accountFilterParams = state.extra as AccountFilterParams; 
        return MaterialPage(
          key: state.pageKey,
          child: AccountListScreen(accountFilterParams: accountFilterParams),
        );
      },
    ),
    GoRoute(
